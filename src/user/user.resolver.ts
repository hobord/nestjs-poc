...
export class UserResolver {
  ...
  @Query(returns => User, {description: 'Get the current authenticated user'})
  @Roles('authenticated')
  ...
  @ResolveProperty(() => Roles, {description: 'Get user\'s roles'})
  @Roles('authenticated')
  @UseGuards(GqlAuthGuard, GqlRolesGuard)
  ...
  @Mutation(() => User, {description: 'Update the current authenticated user'})
  @Roles('authenticated')
  @UseGuards(GqlAuthGuard, GqlRolesGuard)
  ...
  @Mutation(() => User, {description: 'Assign a permission role into the user'})
  @Roles('root', 'usermanager')
  @UseGuards(GqlAuthGuard, GqlRolesGuard)
  async addRoleToUser(
  ...
  @Mutation(() => User, {description: 'Revoke a permission role into the user'})
  @Roles('root', 'usermanager')
  @UseGuards(GqlAuthGuard, GqlRolesGuard)
